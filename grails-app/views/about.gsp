...
<div class="well well-lg">
    <h1 class="text-center">About groovyblogs.org.</h1>
    ...
    <p>
        ...
        sponsored by <a href="http://asergo.com">Asergo</a>
    </p>

    <p>
        The source code is available on <a href="https://github.com/sbglasius/groovyblogs" target="_blank">GitHub</a> and pull requests are more than welcome!
    </p>

    <p>For questions and to give moral support write <a href="mailto:sbglasius(at)groovyblogs.org">sbglasius<i class="fa fa-at"></i>groovyblogs.org</a>.</p>
</div>
