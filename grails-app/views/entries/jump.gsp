...
<div class="groovyblogs-overlay">
    ...
    <div id="loaded-frame" class="loaded-frame">
        <div class="overlay">
            <button type="button" class="close" id="close-modal" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div class="row">
                <div class="col-sm-2">
                    <g:link uri="/"><asset:image src="groovyblogs-vertical.png"/></g:link>
                </div>
                <div class="col-sm-10">
